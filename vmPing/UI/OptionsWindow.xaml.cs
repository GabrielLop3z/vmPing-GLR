...
namespace vmPing.UI
{
    public partial class OptionsWindow : Window
    {
        ...
        private void PopulateNotificationOptions()
        {
            ...
            // Webhook options.
            IsWebhookEnabled.IsChecked = ApplicationOptions.IsWebhookEnabled;
        ...
        {
            ThemeComboBox.SelectedIndex = (int)ApplicationOptions.CurrentTheme;
        }
        ...
        private bool SaveInterfaceOptions()
        {
            var selectedTheme = (ApplicationOptions.AppTheme)ThemeComboBox.SelectedIndex;
            if (ApplicationOptions.CurrentTheme != selectedTheme)
            {
        ...
        private bool SaveNotificationOptions()
        {
            ...
            // Webhook options.
            ApplicationOptions.IsWebhookEnabled = IsWebhookEnabled.IsChecked == true;
