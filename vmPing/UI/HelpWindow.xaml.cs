...
namespace vmPing.UI
{
    public partial class HelpWindow : Window
    {
        ...
        private void UserManual_Selected(object sender, RoutedEventArgs e)
        {
            UserManual?.BringIntoView();
        }

        private void TechnicalManual_Selected(object sender, RoutedEventArgs e)
        {
            TechnicalManual?.BringIntoView();
        }
