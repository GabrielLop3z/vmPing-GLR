    ...
    public partial class Probe
    {
        private async void PerformIcmpProbe(CancellationToken cancellationToken)
        {
            ...
            await Application.Current.Dispatcher.BeginInvoke(
                new Action(() => AddHistory($"*** Ping a {Hostname}:")));
            ...
            if (pingReply != null)
            {
                switch (pingReply.Status)
                {
                    ...
                    case IPStatus.DestinationHostUnreachable:
                        sb.Append("Respuesta  [Host inaccesible]");
                        break;
                    case IPStatus.DestinationNetworkUnreachable:
                        sb.Append("Respuesta  [Red inaccesible]");
                        break;
                    case IPStatus.DestinationUnreachable:
                        sb.Append("Respuesta  [Inaccesible]");
                        break;
                    case IPStatus.TimedOut:
                        sb.Append("Tiempo de espera agotado.");
                        break;
                    default:
