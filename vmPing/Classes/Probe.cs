...
namespace vmPing.Classes
{
    ...
    public partial class Probe : INotifyPropertyChanged
    {
        ...
        public long MaxLatency { get; set; } = 1; // Used for sparkline scaling
        ...
        private ObservableCollection<int> _latencyHistory = new ObservableCollection<int>();
        public ObservableCollection<int> LatencyHistory
        {
            get => _latencyHistory;
            set
            {
                _latencyHistory = value;
                OnPropertyChanged();
            }
        }
