    ...
    internal static class Configuration
    {
        ...
        private static XElement GenerateConfigurationNode()
        {
            ...
            return new XElement("configuration",
                ...
                Node("IsWebhookEnabled", ApplicationOptions.IsWebhookEnabled),
                Node("WebhookUrl", ApplicationOptions.WebhookUrl),
        ...
        private static void LoadAppOptions(XmlNodeList nodes)
        {
            ...
            if (options.TryGetValue("IsWebhookEnabled", out optionValue))
            {
                ApplicationOptions.IsWebhookEnabled = bool.Parse(optionValue);
            }
            ...
            {
                if (Enum.TryParse(optionValue, out ApplicationOptions.AppTheme theme))
                {
